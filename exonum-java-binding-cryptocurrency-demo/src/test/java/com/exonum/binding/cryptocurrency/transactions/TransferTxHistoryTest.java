...
class TransferTxHistoryTest {
  ...
  void executeTransfer() throws CloseFailuresException {
    try (Database db = MemoryDb.newInstance();
      ...
      TransferTx tx = withMockMessage(seed, ACCOUNT_1, ACCOUNT_2, transferSum);
      tx.execute(view);
      ...
      long expectedBalance1 = initialBalance - transferSum + transferSum2;
      assertThat(wallets.get(ACCOUNT_1).getBalance(), equalTo(expectedBalance1));
      long expectedBalance2 = initialBalance + transferSum - transferSum2;
