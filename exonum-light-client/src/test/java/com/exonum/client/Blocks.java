...
public final class Blocks {
  ...
  static final String BLOCK_1_JSON_NO_TIME =
      "{\n"
          ...
          + "        'state_hash': 'efa2'\n"
          + "    }";
  public static final Block BLOCK_1 =
      Block.builder()
          .proposerId(1)
          .height(10)
          .numTransactions(1)
          ...
          .build();
  static final Block BLOCK_1_NO_TIME =
      Block.builder()
          .proposerId(1)
          .height(10)
          .numTransactions(1)
  ...
  static final Block BLOCK_2 =
      Block.builder()
          ...
          .build();
  static final Block BLOCK_2_NO_TIME =
      Block.builder()
          .proposerId(2)
          .height(25)
          .numTransactions(1)
  ...
  static final Block BLOCK_3 =
      Block.builder()
          ...
          .build();
  static final Block BLOCK_3_NO_TIME =
      Block.builder()
          .proposerId(3)
          .height(78)
          .numTransactions(1)
