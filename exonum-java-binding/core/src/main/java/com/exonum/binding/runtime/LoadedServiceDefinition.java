...
interface LoadedServiceDefinition {
  ...
  /**
   * Returns a supplier of {@linkplain com.exonum.binding.service.ServiceModule service modules}
   * configuring their bindings. The supplier will always return the same module corresponding to
   * this service, but not necessarily the same instance.
   */
  Supplier<? extends ServiceModule> getModuleSupplier();
}
