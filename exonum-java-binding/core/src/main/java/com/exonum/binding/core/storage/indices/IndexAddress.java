...
/**
 * An Exonum index address: a pair of the name and an optional id in a group, which identifies an
 * Exonum index.
...
public final class IndexAddress {
   ...
   *
   * @param name the name of the index: a alphanumeric non-empty identifier of the index in the
   *     MerkleDB: [a-zA-Z0-9_]
   */
  ...
  /**
   * Creates an address of an index belonging to an <a href="package-summary.html#families">index
   * group</a>.
   *
   ...
   * @param idInGroup the id of the index in group. See a <a
   *     href="package-summary.html#families-limitations">caveat</a> on index identifiers.
   */
  ...
  public boolean equals(Object o) {
    ...
    return name.equals(that.name) && Arrays.equals(idInGroup, that.idInGroup);
  }
