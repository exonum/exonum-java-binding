 ...
 *
 * @see <a href="https://exonum.com/doc/version/1.0.0/get-started/java-binding/#installation">
 *   Exonum Java installation instructions</a>
 * @see <a href="https://exonum.com/doc/version/1.0.0/get-started/java-binding/#testing">
...
public final class LibraryLoader {
   ...
   * each release</a>.
   */
  private static final String JAVA_BINDING_VERSION = "0.11.0-SNAPSHOT";
    ...
    if (runningUnitTests()) {
      ...
      return String.format(
          "Check that %s system property includes a path to '${EXONUM_HOME}/lib/native' directory%n"
              ...
              + "https://exonum.com/doc/version/1.0.0/get-started/java-binding/#testing",
    ...
    if (!expectedLibVersion.equals(nativeLibVersion)) {
      String message = String.format(
          "Mismatch between versions of Java library and native '%s' library:%n"
              ...
              + "See https://exonum.com/doc/version/1.0.0/get-started/java-binding/#installation",
