...
public interface Node extends AutoCloseable {
   ...
   * adds it to the <a href="https://exonum.com/doc/version/1.0/advanced/consensus/specification/#pool-of-unconfirmed-transactions">pool of unconfirmed transactions</a>.
