...
/**
 * An "unexpected" service execution exception indicates that any exception but {@link
 * ExecutionException} occurred in a service method. The original exception is stored as
 * <em>cause</em>.
 *
