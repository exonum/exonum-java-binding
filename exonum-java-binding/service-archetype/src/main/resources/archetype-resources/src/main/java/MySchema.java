 ...
 *
 * @see <a href="https://exonum.com/doc/version/0.11/architecture/storage/#table-types">Exonum table types.</a>
 */
public final class MySchema implements Schema {
  ...
  public List<HashCode> getStateHashes() {
    ...
    // see https://exonum.com/doc/version/0.11/architecture/storage/#merkelized-indices
