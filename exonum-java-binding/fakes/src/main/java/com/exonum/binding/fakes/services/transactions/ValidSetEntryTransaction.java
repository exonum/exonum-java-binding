 ...
 */
public final class ValidSetEntryTransaction implements Transaction {
   ...
   */
  public ValidSetEntryTransaction(String value) {
  ...
  public static Transaction fromArguments(byte[] arguments) {
    return new ValidSetEntryTransaction(BaseEncoding.base16().encode(arguments));
  }
