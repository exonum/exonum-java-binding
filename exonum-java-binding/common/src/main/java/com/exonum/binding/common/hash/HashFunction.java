 ...
 *       insufficient to hold all hash code values, this API represents a hash code as an instance
 *       of {@link HashCode}.
 ...
 * that you implement a {@link com.exonum.binding.common.hash.Funnel}{@code <T>} to specify how to
 * "feed" data from that object into the function. (See {@linkplain Hasher#putObject an example} of
 * this.)
 *
