...
class ListMerkleRootCalculatorTest {
  ...
  private ListMerkleRootCalculator<String> calculator;
  ...
  private ListMerkleRootCalculator<String> createListProofCalculator(ListProof listProof) {
