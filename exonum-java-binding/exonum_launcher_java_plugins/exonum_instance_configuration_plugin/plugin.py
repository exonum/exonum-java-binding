...
class InstanceSpecLoader(BaseInstanceSpecLoader):
    ...
    def serialize_config_impl(self, config: Any, instance_name: str) -> bytes:
        ...
        self.assert_config_field_exists(config, instance_name, _PROTOBUF_SOURCES_FIELD_NAME)
        self.assert_config_field_exists(config, instance_name, _MODULE_FILENAME_FIELD_NAME)
        self.assert_config_field_exists(config, instance_name, _DATA_FIELD_NAME)
    ...
    @staticmethod
    def assert_config_field_exists(config, instance_name, field_name) -> None:
