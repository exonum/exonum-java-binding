...
/**
 * Static methods to obtain {@link com.exonum.binding.hash.HashFunction} instances, and other static hashing-related
 * utilities.
 *
...
public final class Hashing {
   ...
   * for {@code minimumBits}, will return identically-behaving {@link com.exonum.binding.hash.HashFunction} instances.
   *
   * @param minimumBits a positive integer (can be arbitrarily large)
   * @return a hash function, described above, that produces hash codes of length {@code
   *     minimumBits} or greater
   */
  public static com.exonum.binding.hash.HashFunction goodFastHash(int minimumBits) {
    ...
    com.exonum.binding.hash.HashFunction[] hashFunctions = new com.exonum.binding.hash.HashFunction[hashFunctionsNeeded];
   ...
   */
  public static com.exonum.binding.hash.HashFunction murmur3_32(int seed) {
   ...
   * <p>The exact C++ equivalent is the MurmurHash3_x86_32 function (Murmur3A).
   */
  public static com.exonum.binding.hash.HashFunction murmur3_32() {
   ...
   */
  public static com.exonum.binding.hash.HashFunction murmur3_128(int seed) {
   ...
   * <p>The exact C++ equivalent is the MurmurHash3_x64_128 function (Murmur3F).
   */
  public static com.exonum.binding.hash.HashFunction murmur3_128() {
   ...
   * @since 15.0
   */
  public static com.exonum.binding.hash.HashFunction sipHash24() {
   ...
   * @since 15.0
   */
  public static com.exonum.binding.hash.HashFunction sipHash24(long k0, long k1) {
   ...
   */
  @Deprecated
  public static com.exonum.binding.hash.HashFunction md5() {
    return Md5Holder.MD5;
  }

  private static class Md5Holder {
    static final com.exonum.binding.hash.HashFunction MD5 = new MessageDigestHashFunction("MD5", "Hashing.md5()");
  }
   ...
   */
  @Deprecated
  public static com.exonum.binding.hash.HashFunction sha1() {
    return Sha1Holder.SHA_1;
  }

  private static class Sha1Holder {
    static final com.exonum.binding.hash.HashFunction SHA_1 = new MessageDigestHashFunction("SHA-1", "Hashing.sha1()");
  }

  /** Returns a hash function implementing the SHA-256 algorithm (256 hash bits). */
  public static com.exonum.binding.hash.HashFunction sha256() {
    return Sha256Holder.SHA_256;
  }

  private static class Sha256Holder {
    static final com.exonum.binding.hash.HashFunction SHA_256 =
   ...
   * @since 19.0
   */
  public static com.exonum.binding.hash.HashFunction sha384() {
    return Sha384Holder.SHA_384;
  }

  private static class Sha384Holder {
    static final com.exonum.binding.hash.HashFunction SHA_384 =
  ...
  public static com.exonum.binding.hash.HashFunction sha512() {
    return Sha512Holder.SHA_512;
  }

  private static class Sha512Holder {
    static final com.exonum.binding.hash.HashFunction SHA_512 =
   ...
   * @since 20.0
   */
  public static com.exonum.binding.hash.HashFunction hmacMd5(Key key) {
   ...
   * @since 20.0
   */
  public static com.exonum.binding.hash.HashFunction hmacMd5(byte[] key) {
   ...
   * @since 20.0
   */
  public static com.exonum.binding.hash.HashFunction hmacSha1(Key key) {
   ...
   * @since 20.0
   */
  public static com.exonum.binding.hash.HashFunction hmacSha1(byte[] key) {
   ...
   * @since 20.0
   */
  public static com.exonum.binding.hash.HashFunction hmacSha256(Key key) {
   ...
   * @since 20.0
   */
  public static com.exonum.binding.hash.HashFunction hmacSha256(byte[] key) {
   ...
   * @since 20.0
   */
  public static com.exonum.binding.hash.HashFunction hmacSha512(Key key) {
   ...
   * @since 20.0
   */
  public static com.exonum.binding.hash.HashFunction hmacSha512(byte[] key) {
   ...
   * @since 18.0
   */
  public static com.exonum.binding.hash.HashFunction crc32c() {
   ...
   * HashCode} produced by this function, use {@link com.exonum.binding.hash.HashCode#padToLong()}.
   *
   * <p>This function is best understood as a <a
   * href="https://en.wikipedia.org/wiki/Checksum">checksum</a> rather than a true <a
   * href="https://en.wikipedia.org/wiki/Hash_function">hash function</a>.
   ...
   * @since 14.0
   */
  public static com.exonum.binding.hash.HashFunction crc32() {
   ...
   * @since 14.0
   */
  public static com.exonum.binding.hash.HashFunction adler32() {
  ...
  enum ChecksumType implements Supplier<Checksum> {
    ...
    public final com.exonum.binding.hash.HashFunction hashFunction;
   ...
   *
   * <p>FarmHash fingerprints are encoded by {@link com.exonum.binding.hash.HashCode#asBytes} in little-endian order. This
   * means {@link com.exonum.binding.hash.HashCode#asLong} is guaranteed to return the same value that
   ...
   * @since 20.0
   */
  public static com.exonum.binding.hash.HashFunction farmHashFingerprint64() {
   ...
   */
  public static int consistentHash(com.exonum.binding.hash.HashCode hashCode, int buckets) {
   ...
   */
  public static com.exonum.binding.hash.HashCode combineOrdered(Iterable<com.exonum.binding.hash.HashCode> hashCodes) {
    Iterator<com.exonum.binding.hash.HashCode> iterator = hashCodes.iterator();
    checkArgument(iterator.hasNext(), "Must be at least 1 hash code to combine.");
    int bits = iterator.next().bits();
    byte[] resultBytes = new byte[bits / 8];
    for (com.exonum.binding.hash.HashCode hashCode : hashCodes) {
    ...
    return com.exonum.binding.hash.HashCode.fromBytesNoCopy(resultBytes);
  }
   ...
   *     have the same bit length
   */
  public static com.exonum.binding.hash.HashCode combineUnordered(Iterable<com.exonum.binding.hash.HashCode> hashCodes) {
    Iterator<com.exonum.binding.hash.HashCode> iterator = hashCodes.iterator();
    checkArgument(iterator.hasNext(), "Must be at least 1 hash code to combine.");
   ...
   * @since 19.0
   */
  public static com.exonum.binding.hash.HashFunction concatenating(
      com.exonum.binding.hash.HashFunction first, com.exonum.binding.hash.HashFunction second, com.exonum.binding.hash.HashFunction... rest) {
    // We can't use Lists.asList() here because there's no hash->collect dependency
    List<com.exonum.binding.hash.HashFunction> list = new ArrayList<>();
    list.add(first);
    list.add(second);
    list.addAll(Arrays.asList(rest));
    return new ConcatenatedHashFunction(list.toArray(new com.exonum.binding.hash.HashFunction[0]));
  }
   ...
   * @since 19.0
   */
  public static com.exonum.binding.hash.HashFunction concatenating(Iterable<com.exonum.binding.hash.HashFunction> hashFunctions) {
    checkNotNull(hashFunctions);
    // We can't use Iterables.toArray() here because there's no hash->collect dependency
    List<com.exonum.binding.hash.HashFunction> list = new ArrayList<>();
    for (com.exonum.binding.hash.HashFunction hashFunction : hashFunctions) {
  ...
  private static final class ConcatenatedHashFunction extends AbstractCompositeHashFunction {
    ...
    private ConcatenatedHashFunction(com.exonum.binding.hash.HashFunction... functions) {
      super(functions);
      int bitSum = 0;
      for (com.exonum.binding.hash.HashFunction function : functions) {
    ...
    @Override
    com.exonum.binding.hash.HashCode makeHash(com.exonum.binding.hash.Hasher[] hashers) {
      byte[] bytes = new byte[bits / 8];
      int i = 0;
      for (com.exonum.binding.hash.Hasher hasher : hashers) {
        com.exonum.binding.hash.HashCode newHash = hasher.hash();
        i += newHash.writeBytesTo(bytes, i, newHash.bits() / 8);
      }
      return com.exonum.binding.hash.HashCode.fromBytesNoCopy(bytes);
    }
