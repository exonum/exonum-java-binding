...
mvn install \
  ...
  -pl exonum-light-client,exonum-java-binding/core,exonum-java-binding/fake-service,exonum-java-binding/integration-tests,exonum-java-binding/cryptocurrency-demo \
  -am
