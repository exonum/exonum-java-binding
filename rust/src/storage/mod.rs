...
pub use self::map_index::{Java_com_exonum_binding_index_Map_nativeCreate,
                          Java_com_exonum_binding_index_Map_nativeFree,
                          Java_com_exonum_binding_index_Map_nativeGet,
                          Java_com_exonum_binding_index_Map_nativeContains,
                          Java_com_exonum_binding_index_Map_nativePut,
                          Java_com_exonum_binding_index_Map_nativeDelete,
                          Java_com_exonum_binding_index_Map_nativeClear};
