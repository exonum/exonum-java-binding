...
pub fn get_exception_stack_trace(env: &JNIEnv, exception: JObject) -> JniResult<Option<String>> {
    if cfg!(debug_assertions) {
        ...
        // Stack traces are disabled in release builds.
        //
        // The responsibility for issuing debugging information in the production environment
        // lies on the Java part of the framework.
        Ok(None)
    }
}
