...
QA_SERVICE_TXT="exonum-java-binding-cryptocurrency-demo/target/cryptocurrency-classpath.txt"
...
do
    ejb_port=$((6000 + i))
    ejb-app finalize testnet/sec_$i.toml testnet/node_$i.toml --ejb-module-name 'com.exonum.binding.qaservice.ServiceModule' \
